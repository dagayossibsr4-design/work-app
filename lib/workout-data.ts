...
export const workoutTemplates: WorkoutTemplate[] = [
  ...
  },
  {
    id: "push2",
    name: "Push 2",
    focus: "חזה, כתפיים, יד אחורית ו-Arms/Pump",
    accent: "#F5B72C",
    exercises: [
      standardTwoSet("לחיצת חזה בשיפוע במכונת האמר", "Incline Hammer Strength"),
      { ...standardTwoSet("לחיצת חזה במכונה שטוחה", "Flat Chest Machine"), note: "Rest Pause: 12–15" },
      standardTwoSet("לחיצת כתפיים עליון עם משקולות", "Decline Dumbbell Press"),
      standardTwoSet("פרפר בעמידה בכבלים", "Cable Flies"),
      { id: "פרפר במכונה", name: "פרפר במכונה", englishName: "Pec Deck Machine", sets: [{ target: "12–15", restPause: "סט יחיד עצים" }] },
      standardTwoSet("לחיצת כתפיים במכונה", "Shoulder Press Machine"),
      standardTwoSet("הרחקת זרועות לצדדים במכונה", "Side Laterals Machine"),
      { id: "crucifix", name: "הרחקת זרועות / פשיטת מרפקים בכבלים", englishName: "Crucifix Cable Lateral - Triceps", sets: [{ target: "10–15" }, { target: "10–15" }] },
      standardTwoSet("פשיטת מרפקים לאחור עם משקולות", "Triceps Kick Backs"),
    ],
  },
  {
    id: "pull2",
  ...
  },
  {
    id: "legs2",
    name: "Legs 2",
    focus: "המסטרינג, ארבע־ראשי, מקרבים ותאומים",
    accent: "#FB7185",
    exercises: [
      standardTwoSet("כפיפת ברכיים בשכיבה", "Lying Leg Curl"),
      standardTwoSet("סקוואט במכונת סמית", "Squats in Smith Machine"),
      { id: "האק סקוואט-legs2", name: "האק סקוואט במכונה", englishName: "Hack Squat", sets: [{ target: "12–15", restPause: "סט יחיד עצים" }] },
      { id: "פשיטת ברכיים-legs2", name: "פשיטת ברכיים במכונה", englishName: "Leg Extension", sets: [{ target: "8–12" }, { target: "8–12" }, { target: "8–12" }] },
      { id: "מכרעים", name: "מכרעים בהליכה", englishName: "Lunges Walking", sets: [{ target: "מקסימום" }, { target: "מקסימום" }] },
      standardTwoSet("דדליפט ברכיים ישרות עם משקולות", "Dumbbell Straight Leg Deadlifts"),
      { id: "כפיפת ברכיים-legs2", name: "כפיפת ברכיים בעמידה", englishName: "Leg Curl Standing", sets: [{ target: "15–20", restPause: "סט יחיד עצים" }] },
      standardTwoSet("מקרבי ירך במכונה", "Adductor Machine"),
      standardTwoSet("הרמת עקבים בישיבה", "Calves Sitting"),
      standardTwoSet("הרמת עקבים במכונת חמור", "Donkey Calves"),
    ],
  },
  {
    id: "arms",
