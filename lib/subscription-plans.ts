...
export const SUBSCRIPTION_PLANS: SubscriptionPlan[] = [
  ...
  },
  {
    ...
    priceLabel: "420 ₪ לשנה",
    priceIls: 420,
    description: "גישה מלאה לאורך שנה במסלול מרוכז ונוח - בממוצע 35 ₪ לחודש בלבד.",
    highlights: ["כל אפשרויות המסלול החודשי", "חיסכון של 48 ₪ לעומת 12 חודשים במסלול החודשי", "ניהול מנוי מסודר"],
    featured: true,
  },
];
