...
export const workoutEncyclopediaCategories: WorkoutEncyclopediaCategory[] = [
  ...
  { id: "women-lower-body", title: "נשים, ישבן ויציבה", englishTitle: "Women's Toning, Glutes & Posture", description: "בניית ועיצוב הישבן, קו מותניים, פלג גוף עליון ויציבה.", accent: "#E38BFF", programIds: ["glute-shape", "glute-medius-waist", "upper-body-posture", "prenatal-postnatal"], sourcePages: [4, 5] },
