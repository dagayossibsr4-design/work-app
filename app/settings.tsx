...
const links = [
  ["לוח אימונים שבועי", "/(tabs)/schedule"], ["תבניות ותרגילים", "/(tabs)/editor"], ["חמש ארוחות", "/(tabs)/meal-plan"], ["היסטוריית אימונים", "/(tabs)/history"], ["ניתוח והתקדמות", "/(tabs)/analysis"], ["אירובי", "/(tabs)/cardio"], ["התאוששות ושינה", "/(tabs)/recovery"], ["Garmin Connect", "/(tabs)/garmin"], ["חילוץ תווית מזון באמצעות AI", "/food-label"], ["יעדים שבועיים לפרופיל", "/weekly-goals"],
] as const;
