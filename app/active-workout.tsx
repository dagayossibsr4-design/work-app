...
const styles = StyleSheet.create({
  ...
  setRow: { flexDirection: "row-reverse", alignItems: "center", gap: 7, borderTopColor: "#2C3B55", borderTopWidth: 1, paddingTop: 8 }, setRowDone: { opacity: 0.62 }, setCheck: { width: 34, height: 34, flexShrink: 0, borderRadius: 9, backgroundColor: "#253653", alignItems: "center", justifyContent: "center" }, setCheckDone: { backgroundColor: "#F5B72C" }, setCheckText: { color: "#F7F9FC", fontWeight: "900" }, setInputGroup: { flex: 1, minWidth: 0, gap: 3 }, setLabel: { color: "#AAB7C8", fontSize: 9, textAlign: "right" }, setInput: { height: 36, minWidth: 0, backgroundColor: "#0B1224", borderColor: "#3C4E6A", borderWidth: 1, borderRadius: 8, color: "#F7F9FC", textAlign: "center", paddingHorizontal: 5 }, setFieldWithArrows: { flex: 1, minWidth: 0, flexDirection: "row", alignItems: "flex-end", gap: 4 }, arrowColumn: { flexShrink: 0, gap: 3, paddingBottom: 1 }, arrowButton: { width: 24, height: 17, borderRadius: 5, backgroundColor: "#253653", alignItems: "center", justifyContent: "center" }, arrowText: { color: "#8FD3F4", fontSize: 9, fontWeight: "900" }, cardioFields: { flex: 1, gap: 7 }, cardioMeasureRow: { flexDirection: "row-reverse", gap: 7 }, cardioIntensityRow: { flexDirection: "row-reverse", gap: 5 }, cardioIntensity: { flex: 1, borderColor: "#3C4E6A", borderWidth: 1, borderRadius: 7, paddingVertical: 6, alignItems: "center" }, cardioIntensityActive: { backgroundColor: "#42D392", borderColor: "#42D392" }, cardioIntensityText: { color: "#AAB7C8", fontSize: 9, fontWeight: "900" }, cardioIntensityTextActive: { color: "#09221D" }, cardioNoteInput: { minHeight: 34, backgroundColor: "#0B1224", borderColor: "#3C4E6A", borderWidth: 1, borderRadius: 8, color: "#F7F9FC", textAlign: "right", paddingHorizontal: 7, fontSize: 10 }, removeSet: { width: 30, height: 30, flexShrink: 0, borderRadius: 15, backgroundColor: "#3A2028", alignItems: "center", justifyContent: "center" }, removeSetText: { color: "#FF93AB", fontSize: 19, fontWeight: "900" }, finishButton: { minHeight: 54, backgroundColor: "#F5B72C", borderRadius: 14, alignItems: "center", justifyContent: "center", marginTop: 4 }, finishText: { color: "#0B1224", fontSize: 14, fontWeight: "900" }, methodButton: { minHeight: 34, maxWidth: 150, borderRadius: 9, borderWidth: 1, borderColor: "#526B8E", backgroundColor: "#101C31", paddingHorizontal: 8, alignItems: "center", justifyContent: "center" }, methodButtonSelected: { borderColor: "#D77CFF", backgroundColor: "#33265C" }, methodButtonText: { color: "#D8A2F4", fontSize: 9, fontWeight: "900", textAlign: "center" },
