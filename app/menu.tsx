...
const sections = [
  ...
  { title: "הגדרות וחיבורים", items: [["הרשמה / התחברות", "/register"], ["עריכת תבניות", "/(tabs)/editor"], ["הגדרות", "/settings"], ["איך משתמשים באפליקציה", "/guide"], ["TRT וסטרואידים — מידע בטוח", "/hormone-health"], ["יומן מעקב אישי ותוספים", "/hormone-tracking"], ["פרטיות ומידע משפטי", "/legal"], ["פאנל ניהול", ADMIN_PANEL_PATH]] },
] as const;
