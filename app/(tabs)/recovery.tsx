  ...
  return (
    <ScreenContainer className="px-5 pt-5" containerClassName="bg-background">
      <ScrollView showsVerticalScrollIndicator={false} keyboardShouldPersistTaps="handled" contentContainerStyle={styles.content}>
        <View style={styles.heading}><Text style={styles.eyebrow}>מעקב אישי</Text><Text style={styles.title}>שינה והתאוששות</Text><Text style={styles.subtitle}>הזן נתוני שינה, עייפות וכאבי שרירים כדי לעקוב אחרי ההתאוששות שלך</Text></View>
