      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.content}>
        <View style={styles.header}>
          <View style={styles.headerActions}>
            ...
            <Pressable accessibilityRole="button" accessibilityLabel="הרשמה או התחברות" onPress={() => router.push("/register" as never)} style={styles.accountButton}><Text style={styles.accountButtonText}>הרשמה / התחברות</Text></Pressable>
          </View>
