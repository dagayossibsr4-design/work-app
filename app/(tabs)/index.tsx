      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.content}>
        <View style={styles.header}>
          <View style={styles.titleBlock}>
            <View style={styles.logoWrap}><BrandMark variant="wordmark" /></View>
        ...
        <View style={styles.personalProfilePanel}>
          ...
          <View style={styles.personalProfileList}>{[
            { id: "onboarding", title: "צור פרופיל חדש", description: "משקל, יעד קלורי, מספר ארוחות ותוכנית אימון - בנייה אוטומטית של הכל" },
...
const styles = StyleSheet.create({
  ...
  title: { color: "#F7F9FC", fontSize: 20, lineHeight: 25, fontWeight: "800", textAlign: "right", alignSelf: "flex-end" },
